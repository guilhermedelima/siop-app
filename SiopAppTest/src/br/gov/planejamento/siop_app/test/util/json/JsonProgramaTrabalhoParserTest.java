...
public class JsonProgramaTrabalhoParserTest extends TestCase{
	...
	public void setUp() throws Exception {
		response = "{ \"head\": { \"link\": [], \"vars\": [\"funcao\", \"subfuncao\", \"uo\", \"programa\", \"acao\", \"subtitulo\", \"ploa\", \"loa\", \"atual\", \"empenhado\", \"liquidado\", \"pago\"] },  \"results\": { \"distinct\": false, \"ordered\": true, \"bindings\": [    { \"funcao\": { \"type\": \"literal\", \"value\": \"Judici\u00E1ria\" }	, \"subfuncao\": { \"type\": \"literal\", \"value\": \"Administra\u00E7\u00E3o Geral\" }	, \"uo\": { \"type\": \"literal\", \"value\": \"Tribunal Regional Eleitoral do Distrito Federal\" }	, \"programa\": { \"type\": \"literal\", \"value\": \"Gest\u00E3o do Processo Eleitoral\" }	, \"acao\": { \"type\": \"literal\", \"value\": \"Julgamento de Causas e Gest\u00E3o Administrativa na Justi\u00E7a Eleitoral\" }	, \"subtitulo\": { \"type\": \"literal\", \"value\": \"No Distrito Federal\" }	, \"ploa\": { \"type\": \"typed-literal\", \"datatype\": \"http://www.w3.org/2001/XMLSchema#double\", \"value\": \"12651855\" }	, \"loa\": { \"type\": \"typed-literal\", \"datatype\": \"http://www.w3.org/2001/XMLSchema#double\", \"value\": \"12651855\" }	, \"atual\": { \"type\": \"typed-literal\", \"datatype\": \"http://www.w3.org/2001/XMLSchema#double\", \"value\": \"15015755\" }	, \"empenhado\": { \"type\": \"typed-literal\", \"datatype\": \"http://www.w3.org/2001/XMLSchema#double\", \"value\": \"14236189.59\" }	, \"liquidado\": { \"type\": \"typed-literal\", \"datatype\": \"http://www.w3.org/2001/XMLSchema#double\", \"value\": \"14236189.59\" }	, \"pago\": { \"type\": \"typed-literal\", \"datatype\": \"http://www.w3.org/2001/XMLSchema#double\", \"value\": \"9572739.35\" }} ] } }";
		emptyResponse = "{ \"head\": { \"link\": [], \"vars\": [\"funcao\", \"subfuncao\", \"uo\", \"programa\", \"acao\", \"subtitulo\", \"ploa\", \"loa\", \"atual\", \"empenhado\", \"liquidado\", \"pago\"] },  \"results\": { \"distinct\": false, \"ordered\": true, \"bindings\": [ ] } }";
	...
	public void testResponseText(){
		...
		Assert.assertTrue(map.containsKey(ClassifierType.SUBTITULO.getId()));
